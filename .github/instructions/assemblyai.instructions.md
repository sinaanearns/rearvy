---
description: "AssemblyAI guidance for Rearvy's Maria and desktop/local-server integration"
applyTo:
  - "desktop-app/**/*"
  - "website/src/app/maria/**/*"
  - "website/src/app/maria-listener/**/*"
---
...
- For Maria, keep the wake-word listener lightweight and route transcription through the desktop server instead of wiring AssemblyAI directly into the client.
- If the visual Maria panel is disabled, preserve voice-only behavior and do not reintroduce a UI dependency just to support speech.
