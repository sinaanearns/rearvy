...
|---|---|---|
| Pre‑history / `main.py` stub | before 2026‑02‑22 | `print("Hello from rearvy2-0!")` placeholder + Python venv |
...
- **Stubs / planned (not implemented):** `main.py` (placeholder), `claude-bedrock/` (dependency‑only, no source), Qlib signal provider (documented Phase 6, not built).
