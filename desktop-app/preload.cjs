...
contextBridge.exposeInMainWorld("electron", {
  ...
  automation: {
    ...
    getBackendCapabilities: () =>
      ipcRenderer.invoke("desktop:automation:get-backend-capabilities"),
  ...
  // The raw automation bridge is intentionally observation-only. All desktop
  // control is submitted as an approval-gated workflow via `automation`.
  agentDesktop: {
