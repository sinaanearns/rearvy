...
const BLOG_POSTS = [
  {
    title: "How E-Commerce Businesses Use Rearvy in 2026",
    category: "E-commerce",
    readTime: "6 min read",
    summary:
      "See how e-commerce teams use Rearvy to research products, coordinate Shopify setups, plan promotions, and manage growth workflows from one place.",
  },
  {
    ...
    readTime: "5 min read",
    summary:
      "Explore how local service companies coordinate follow-ups, customer communication, and everyday operations with Rearvy.",
  },
  {
    ...
    readTime: "6 min read",
    summary:
      "Learn how agencies bring client work, research, approvals, and execution into one coordinated operating layer.",
  },
  {
    ...
    readTime: "5 min read",
    summary:
      "Learn how coaches and consultants organize client work, reduce routine administration, and keep delivery moving.",
  },
  {
    ...
    readTime: "6 min read",
    summary:
      "Explore how real estate teams use Rearvy to research opportunities, coordinate follow-ups, and move work forward.",
  },
...
export const metadata: Metadata = {
  title: "Blog | Rearvy",
  description:
    "Explore practical guides to using Rearvy across e-commerce, agencies, local services, content, automation, and more.",
};
