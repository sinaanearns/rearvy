    ...
    <html lang="en">
      <body>
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0d1117] px-4 py-10 font-sans text-white">
          ...
          <section className="relative w-full max-w-2xl overflow-hidden rounded-[8px] border border-white/12 bg-white/8 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl sm:p-8">
