...
import { metadata as featuresMetadata } from "./features/layout";
...
test("features page metadata has one canonical title style", () => {
  assert.equal(featuresMetadata.title, "Features | Rearvy");
});
