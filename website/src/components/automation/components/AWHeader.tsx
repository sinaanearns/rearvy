...
export function AWHeader({
  ...
  return (
    <div className="border-b border-slate-200 px-4 py-3 dark:border-slate-800">
      ...
      <div className="mt-3 grid gap-2 rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/60 xl:grid-cols-[1fr_auto] xl:items-center">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <input
            ...
            className="h-10 min-w-[280px] rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none ring-0 placeholder:text-slate-400 focus:border-blue-500 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
          />
          <div className="flex flex-wrap gap-2">
            <Button variant="outline" className="h-10 rounded-xl" onClick={onPickFolder}>
              <Search className="mr-2 h-4 w-4" />Browse
            </Button>
            <Button variant="outline" className="h-10 rounded-xl" onClick={onUseCurrentFolder}>
              <FolderOpen className="mr-2 h-4 w-4" />Use current folder
            </Button>
            <Button variant="outline" className="h-10 rounded-xl" onClick={onClearScope}>
              Clear
            </Button>
            <Button className="h-10 rounded-xl bg-amber-600 text-white hover:bg-amber-700" onClick={onUseFullAccess}>
              Full access
            </Button>
          </div>
        </div>
