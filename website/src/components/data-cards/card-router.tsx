...
import { ConnectorWorkflowCard } from "@/components/work/connector-workflow-card";
...
export function CardRouter({
    ...
    switch (toolName) {
        ...
        case "generateSubtitles":
            return <SubtitlesCard data={data} />;
        ...
        case "executeWorkflow":
            return null;
        case "executionRun":
            return isRecord(data.execution) && typeof data.execution.executionId === "string"
                ? <ConnectorWorkflowCard output={data} />
                : <GenericMetricCard data={data} toolName={toolName} />;
        default:
            return <GenericMetricCard data={data} toolName={toolName} />;
    }
}
