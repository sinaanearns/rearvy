...
import { ArrowUpRight, Bell, CheckCircle2, Clock3, Sparkles, Wallet, ShieldCheck } from "lucide-react";
...
export default function BusinessOutcomeBoard() {
  return (
    <div className="relative w-full max-w-[540px]">
      <div className="glass-panel cinematic-glow overflow-hidden border border-white/10 bg-white/[0.04] p-5">
        <div className="flex items-start justify-between gap-4 border-b border-white/10 pb-4">
          <div>
            ...
            <p className="mt-2 max-w-md text-sm leading-6 text-white/65">
              Rearvy turns business signals into a short, prioritized brief for agencies, SaaS teams, and operators.
            </p>
          </div>
