...
const MARKER_TONE_CLASSES: Record<
  NonNullable<MapMarkerDatum["tone"]>,
  string
> = {
...
export function BaseMap({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col overflow-hidden rounded-[8px] border border-border/70 bg-background",
        className,
      )}
    >
