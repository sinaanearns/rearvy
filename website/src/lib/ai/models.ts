...
export const DEFAULT_CHAT_MODEL_TIER: BuiltInChatModelTier = "rearvy-general-5.5";
...
function getApiKeySourceLabel(source: ChatModelApiKeySource) {
  ...
  if (source === "gamma" || source === "rearvy-general-5.5") {
    return "Rearvy General 5.5";
  }

  if (source === "nemotron-omni" || source === "rearvy-expert-2.7") {
    return "Rearvy Expert 2.7";
  }
...
export const CHAT_MODEL_OPTIONS: Record<BuiltInChatModelTier, ChatModelOption> = {
  "rearvy-general-5.5": {
    id: "rearvy-general-5.5",
    label: "Rearvy General 5.5",
    description: "Rearvy General Model 5.5 (Fast, versatile reasoning & automation)",
    provider: "nvidia",
  ...
  "rearvy-expert-2.7": {
    id: "rearvy-expert-2.7",
    label: "Rearvy Expert 2.7",
    description: "Rearvy Expert Model 2.7 (Deep reasoning, code & complex orchestration)",
    provider: "nvidia",
  ...
  auto: {
    id: "auto",
    label: "Auto Router",
    description: "Fast router automatically picks the best model",
    provider: "auto",
    providerModel: "auto",
    apiKeySource: "gamma",
  },
...
function toBuiltInChatModelTier(value: unknown): BuiltInChatModelTier | null {
  if (
    value === "rearvy-general-5.5" ||
    value === "rearvy-expert-2.7" ||
    value === "auto" ||
    value === "gamma" ||
    value === "kimi-k2.5" ||
    value === "nemotron-omni" ||
...
export function getAvailableChatModels(
  ...
  return [
    CHAT_MODEL_OPTIONS["rearvy-general-5.5"],
    CHAT_MODEL_OPTIONS["rearvy-expert-2.7"],
    ...safeCustomModels,
  ];
}
