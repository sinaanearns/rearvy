...
import { firecrawlInteract } from "./firecrawl-interact";
...
export async function createToolRegistry(
  ...
  const baseTools = {
    ...
    firecrawlInteract: firecrawlInteract(ctx),
    ...
    generateSubtitles: generateSubtitles(ctx),
    ...
    updateProfile: updateProfile(ctx),
